...
CAdminApp::CAdminApp() noexcept
{
	...
	SetAppID(_T("Admin.AppID.NoVersion"));
...
// CAdminApp customization load/save methods

void CAdminApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CAdminApp::LoadCustomState()
{
}

void CAdminApp::SaveCustomState()
{
}
